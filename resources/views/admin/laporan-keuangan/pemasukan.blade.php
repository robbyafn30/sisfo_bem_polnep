                                            ...
                                            <div class="modal-dialog " role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="container">
                                                            <form id="" action="/admin/laporan-keuangan/pemasukan" method="post" enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="row mt-3">
                                                                    <div class="col-md-12 mb-3">
                                                                        <div class="form-floating">
                                                                            ...
                                                                            <select class="form-control" name="jenis" required>
                                                                                ...
                                                                                <option value="Pengeluaran" disabled>Pengeluaran</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <td>
                                                                <div uk-lightbox class="p-2">
                                                                    <a href="{{ asset('assets/BuktiLaporanKeuangan/Pemasukan/' . $data->bukti) }}">
                                                                        <img src="{{ asset('assets/BuktiLaporanKeuangan/Pemasukan/' . $data->bukti) }}" height="150px" alt="">
                                                                    </a>
                                                                </div>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <div class="modal fade" id="edit{{$data->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                                <div class="modal-dialog " role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-body">
                                                                            <div class="container">
                                                                                <form id="Update-Pemasukan" action="/admin/laporan-keuangan/pemasukan/{{$data->id}}"  method="post" enctype="multipart/form-data">
                                                                                    @csrf
                                                                                    <div class="row mt-3">
                                                                                        <div class="col-sm-12 mb-3">
                                                                                            <div class="form-floating">
                                                                                            ...
                                                                                            <div class="form-floating mb-3">
                                                                                                ...
                                                                                                <div class="d-flex">
                                                                                                    ...
                                                                                                    <div class="col-md-8 p-0">
                                                                                                        <a href="{{ asset('assets/BuktiLaporanKeuangan/Pemasukan/' . $data->bukti) }}">
                                                                                                            <img src="{{ asset('assets/BuktiLaporanKeuangan/Pemasukan/' . $data->bukti) }}" height="100px" alt="">
                                                                                                        </a>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
        ...
        $('.swa_btn_delete').click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location = "/admin/laporan-keuangan/pemasukan/delete/"+no_id+""
                    Swal.fire(
                        'Berhasil!',
                        'Data telah dihapus.',
                        'success'
