                                            ...
                                            <div class="modal-dialog " role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="container">
                                                            <form id="" action="/admin/data-surat/surat-masuk/"
                                                                ...
                                                                <div class="row mt-3">
                                                                    <div class="col-md-12 mb-3">
                                                                        <div class="form-floating">
                                                                            ...
                                                                            <select class="form-control" name="keterangan" required>
                                                                                ...
                                                                                <option value="Surat Keluar" disabled>Surat Keluar</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-floating mb-3">
                                                                            <label>Dokumen</label>
                                                                            <input name="dokumen" type="file" class="form-control" accept=".pdf, .docx" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($surat as $data)
                                                        <tr class="text-center">
                                                            ...
                                                            <td>{{ Carbon\Carbon::parse($data->tgl_ket_surat)->isoformat(' D MMMM Y') }}
                                                            </td>
                                                            <td>
                                                                <a href="#!"
                                                                    onclick="newTab('{{ asset('assets/DataSurat/SuratMasuk/' . $data->dokumen) }}')">
                                                                    <p>Download</p>
                                                                </a>
                                                            </td>
                                                            <td>
                                                                <div class="form-button-action">
                                                                    ...
                                                                    <button type="button" data-toggle="tooltip"
                                                                        title=""
                                                                        class="btn btn-link btn-danger swa_btn_delete"
                                                                        data-id="{{ $data->id }}">
                                                                ...
                                                                <div class="modal-dialog " role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-body">
                                                                            <div class="container">
                                                                                <form id=""
                                                                                    action="/admin/data-surat/surat-masuk/{{ $data->id }}"
                                                                                    method="post"
        ...
        $('.swa_btn_delete').click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location = "/admin/data-surat/surat-masuk/delete/" + no_id + ""
                    Swal.fire(
                        'Berhasil!',
                        'Data telah dihapus.',
                        'success'
